...
/**
 * Created by jackchu on 16/10/2017.
 */
        ...
        public void onReceive(Context c, Intent intent) {
            if (scanClicked) {
                ...
                if (wifiScanList.size() == 0){
                    Toast.makeText(Main2Activity.this,"No Networks Found", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                for (int i = 0; i < wifiScanList.size(); i++) {
                    ...
                    //issue was the array was not full so it crashed the listView with the last results being null
                    //wifis[i] = ((wifiScanList.get(i)).toString());
                    //wifis[i] = wifiScanList.get(i).SSID + " (" + wifiScanList.get(i).BSSID + ") " + wifiScanList.get(i).level;
                }

                //lv.setAdapter(new ArrayAdapter<String>(MainActivity.this, android.R.layout.simple_list_item_1, wifis));
                lv.setAdapter(new ArrayAdapter<String>(Main2Activity.this, android.R.layout.simple_list_item_1, android.R.id.text1, wifiList));
                scanClicked=false;
